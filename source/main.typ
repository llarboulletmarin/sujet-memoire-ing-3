...
L’objectif principal de ce projet est de concevoir un outil métier pour le suivi de l’EBT, en tenant compte des spécificités des équipes métiers et des exigences réglementaires de la CRE. Cet outil devra être fiable et parfaitement intégré aux systèmes d’information existants de GRTgaz, tout en simplifiant et en optimisant les processus actuels.
...
Enfin, la conduite du changement jouera un rôle crucial dans ce projet. Pour permettre une transition fluide vers ce nouvel outil, des formations spécifiques et un accompagnement personnalisé seront proposés aux utilisateurs. Cela inclura des sessions pratiques et un suivi étroit pour répondre aux besoins des équipes. L’objectif est de transférer les compétences nécessaires et de garantir une appropriation complète de l’outil, tout en assurant la continuité des opérations. Une démarche de gestion des connaissances viendra soutenir ces actions en centralisant les bonnes pratiques et les retours d’expérience, afin d’enrichir les compétences des équipes sur le long terme.

= Résultats attendus

Le projet doit aboutir à la mise en production d’un outil métier opérationnel pour le suivi de l’EBT, destiné à remplacer les solutions informelles actuellement utilisées.
...
Enfin, l’intégration réussie de cet outil dans les pratiques métiers de GRTgaz passera par une adoption par les équipes. Celle-ci sera soutenue par une documentation claire, des formations adaptées et un transfert de compétences.
...
Mon rôle consistera à superviser l’ensemble de cette phase, depuis la conception initiale jusqu’à l’intégration des retours des utilisateurs. Je serai également responsable de coordonner les ajustements nécessaires tout au long du développement, en veillant à ce que le produit final soit conforme aux attentes du métier.
